...
class Enterprise_Checkout_Model_Cart_Sku_Source_Settings
{
    ...
    public function toOptionArray()
    {
        return array(
            array(
                'label' => Mage::helper('enterprise_checkout')->__('Yes, for Specified Customer Groups'),
                'value' => self::YES_SPECIFIED_GROUPS_VALUE
            ),
            array(
                'label' => Mage::helper('enterprise_checkout')->__('Yes, for Everyone'),
                'value' => self::YES_VALUE
            ),
            array(
                'label' => Mage::helper('enterprise_checkout')->__('No'),
                'value' => self::NO_VALUE
            ),
        );
    }
