...
/**
 * Gift Registry Item list render block for simple and default product
 *
 * @category    Enterprise
 * @package     Enterprise_GiftRegistry
...
class Enterprise_GiftRegistry_Block_Items_Renderer extends Mage_Checkout_Block_Cart_Item_Renderer
{
    /**
