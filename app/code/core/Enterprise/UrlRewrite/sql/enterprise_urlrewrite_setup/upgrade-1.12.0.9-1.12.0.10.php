...
Mage::getModel('enterprise_mview/metadata')
    ->setViewName('enterprise_url_rewrite_redirect')
    ->setTableName($this->getTable('enterprise_url_rewrite_redirect'))
    ->save();
...
$client->getMetadata()
    ->setKeyColumn('redirect_id')
    ->setGroupCode('url_redirect')
...
$client->execute('enterprise_urlrewrite/index_action_url_rewrite_changelog_create', array(
    'table_name' => $this->getTable('enterprise_urlrewrite/redirect')
));

$client->execute('enterprise_mview/action_changelog_subscription_create', array(
    'target_table' => $this->getTable('enterprise_urlrewrite/redirect'),
    'target_column' => 'redirect_id'
));
