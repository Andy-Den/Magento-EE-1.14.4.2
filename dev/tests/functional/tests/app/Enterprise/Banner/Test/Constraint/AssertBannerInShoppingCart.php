...
/**
 * Assert that banner is present on Shopping Cart page.
 */
class AssertBannerInShoppingCart extends AbstractConstraint
{
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            $checkoutCart->getBannerViewBlock()->checkWidgetBanners($banner),
            'Banner is absent on Shopping Cart page.'
        );
    }
    ...
    {
        return 'Banner is present on Shopping Cart page.';
    }
}
