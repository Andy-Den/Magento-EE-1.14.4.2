...
/**
 * Check appearance of success message on Catalog Event page.
 */
class AssertCatalogEventSuccessCreateMessage extends AbstractConstraint
{
     ...
     */
    const SUCCESS_MESSAGE = 'Event has been saved.';
    ...
    {
        return 'Event success save message is present on Catalog Event page.';
    }
}
