...
abstract class AbstractSku extends Form
{
     ...
     * @var string
     */
    protected $firstRow = './/tr[td/*[contains(@id,"input_sku")]]';
    ...
    public function fillForm(array $orderOptions)
    {
        foreach ($orderOptions as $key => $value) {
            ...
            if ($key == 0 && $this->_rootElement->find($this->firstRow, Locator::SELECTOR_XPATH)->isVisible()) {
                $element = $this->_rootElement->find($this->firstRow, Locator::SELECTOR_XPATH);
            } else {
