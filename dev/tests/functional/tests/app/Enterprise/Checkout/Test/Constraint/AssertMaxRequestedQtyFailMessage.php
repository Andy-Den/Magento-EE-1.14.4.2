 ...
 */
class AssertMaxRequestedQtyFailMessage extends AbstractAssertRequestedQtyFailMessage
{
    /**
     ...
     * @var string
     */
    protected $allowedQtyMessage = 'The maximum quantity allowed for purchase is %d.';
     ...
     * @var string
     */
    protected $saleQtyType = 'max_sale_qty';
