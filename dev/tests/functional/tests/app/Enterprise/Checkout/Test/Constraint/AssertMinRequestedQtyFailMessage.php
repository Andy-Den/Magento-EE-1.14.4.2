 ...
 */
class AssertMinRequestedQtyFailMessage extends AbstractAssertRequestedQtyFailMessage
{
    /**
     ...
     * @var string
     */
    protected $allowedQtyMessage = 'The minimum quantity allowed for purchase is %d.';
     ...
     * @var string
     */
    protected $saleQtyType = 'min_sale_qty';
