...
/**
 * Assert that after adding products by sku to order, disable error message appears.
 */
class AssertProductIsDisabledFailMessage extends AbstractConstraint
{
    /* tags */
    const SEVERITY = 'low';
    /* end tags */
    ...
    /**
     * Disable product error message.
     */
    const ERROR_MESSAGE = 'This product is currently disabled.';
    ...
    {
        return 'Product is disable message is present after adding products to order by sku.';
    }
}
