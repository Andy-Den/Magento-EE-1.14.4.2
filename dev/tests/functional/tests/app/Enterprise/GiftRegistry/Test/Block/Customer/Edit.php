...
class Edit extends Form
{
     ...
     * @throws \Exception
     */
    public function fillGiftRegistry(GiftRegistry $giftRegistry, Element $element = null)
    {
        $giftRegistryData = $giftRegistry->getData();
        unset($giftRegistryData['type_id']);
        $mapping = $this->dataMapping($giftRegistryData);
