...
use Enterprise\UrlRewrite\Test\Fixture\UrlRewriteType;
...
class CreateProductUrlRewriteEntityTest extends Injectable
{
     ...
     * @param UrlRewriteType $urlRewriteType
     * @return void
     */
    public function test(UrlRewrite $urlRewrite, UrlRewriteType $urlRewriteType)
    {
        ...
        $this->urlRewriteSelect->getSelectTypeForm()->fill($urlRewriteType);
