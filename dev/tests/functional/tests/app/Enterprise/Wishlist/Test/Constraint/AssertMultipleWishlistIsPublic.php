...
use Enterprise\Wishlist\Test\Page\SearchResult;
...
/**
 * Assert that wish list is public.
 */
class AssertMultipleWishlistIsPublic extends AbstractConstraint
{
    /* tags */
    const SEVERITY = 'low';
    /* end tags */
    ...
    public function processAssert(
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            $searchResult->getWishlistSearchResultBlock()->isWishlistVisibleInGrid($wishlist),
            "Multiple wishlist is not visible on wishlist search result page."
        );
    }
