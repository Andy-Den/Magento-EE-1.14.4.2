...
namespace Enterprise\Wishlist\Test\Handler\WishlistWidget;
...
class Curl extends \Mage\Widget\Test\Handler\Widget\Curl
{
    ...
    protected $additionalMappingData = [
        'type' => [
            'Wishlist Search' => 'enterprise_wishlist-widget_search',
        ],
        'template' => [
            'Wishlist Search Template' => 'wishlist/widget/search.phtml',
        ],
    ];
