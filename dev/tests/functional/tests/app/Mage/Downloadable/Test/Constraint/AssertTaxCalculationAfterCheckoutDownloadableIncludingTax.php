...
use Mage\Tax\Test\Constraint\AssertTaxCalculationAfterCheckoutIncludingTax;

/**
 * Checks that prices incl tax on order review and customer order pages are equal to specified in dataset.
 */
class AssertTaxCalculationAfterCheckoutDownloadableIncludingTax extends AssertTaxCalculationAfterCheckoutIncludingTax
{
    /**
