...
use Mage\Tax\Test\Constraint\AssertTaxRuleIsAppliedToAllPricesIncludingTax;

/**
 * Checks that prices incl tax on category, product and cart pages are equal to specified in dataset.
 */
class AssertTaxRuleIsAppliedToAllPricesDownloadableIncludingTax extends AssertTaxRuleIsAppliedToAllPricesIncludingTax
{
    /**
