...
/**
 * Assert that success create message appears after creating order on backend.
 */
class AssertOrderCreateSuccessMessage extends AbstractConstraint
{
    /* tags */
    const SEVERITY = 'low';
    /* end tags */
     ...
     */
    const SUCCESS_MESSAGE = "The order has been created.";
